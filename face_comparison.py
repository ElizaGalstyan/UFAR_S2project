...
class FaceComparer:
    ...
    def display_images(self):
        width = 700
        height = 700
        self.img1 = cv2.resize(self.img1, (width, height))
        self.img2 = cv2.resize(self.img2, (width, height))
...
FaceComparer('a1.png', 'a2.jpeg').img_compare()
FaceComparer('b1.jpeg', 'b2.jpeg').img_compare()
FaceComparer('c1.jpg', 'c2.jpg').img_compare()